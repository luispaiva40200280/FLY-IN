...
class ZoneType(Enum):
    """
    Simple Enum class to hold all the zone Types of the map
    """
    NORMAL = 'normal'
    BLOCKED = 'blocked'
...
class DroneState(Enum):
    """
    Simple Enum class to hold all the Drone states
    """
    WAITING = 'waiting'
...
class Coolors(Enum):
    ...
    def get_color(cls, color_name: str) -> str:
        ...
        Args:
            color_name (str): value of the color to retreve in ANSCI
                code

        Returns:
            str: ANSCI value of the specific coolor if it exist else the
                ANSCI value to reset the termianal to there original color
        """
